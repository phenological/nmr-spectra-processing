...
#'   series
#'  \item A number \code{<= dim(x)[1]}: row index of the input series to be used
#'  as reference
...
#'  \item character: "median" (default) or "mean", use the median or mean of the
#'  input series as reference.}
